...
#' @param data list containing the data where the matrix of 2-dimensional regressors 
#'              are a single element in the list, y containing the N x m matrix of 
#'              longitudinal observations
#' @param weights an N*(m-1)x1 vector of innovation variances
